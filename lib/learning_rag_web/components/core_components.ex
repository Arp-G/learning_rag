defmodule LearningRagWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LearningRagWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LearningRagWeb.Gettext, "errors", msg, opts)
    end
  end
